...
'''
    Logistic Regression:
    Implement the logistic regression method for binary classification problems.
    Compute gradient using the chain rule.
    Use use cross entropy as the loss function and stochastic gradient descent to train the model parameters.
